            ...
            children: [
              ...
              Container(
                ...
                child: ListView.separated(
                  ...
                  itemCount: StudentHomeAppointments.getStudentHomeAppointments().length,
                  itemBuilder: (context, index) {
                    var appointment = StudentHomeAppointments.getStudentHomeAppointments()[index];
              ...
              // Here you can add the widget to display appointments
            ],
          )
        ],
      )
